...
flowchart TD
    ...
    subgraph Наша система
        APP[Backend API - монолит: бизнес-логика, авторизация и тд]
...
- **Backend API** - монолит: авторизация, основная бизнес-логика: управление вакансиями, графами компетенций, маппингами, ранжированием. Синхронные операции (CRUD, чтение рейтинга) обрабатываются здесь напрямую.
