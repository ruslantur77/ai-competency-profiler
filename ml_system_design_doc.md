...
Вход: неструктурированный текст вакансии. Выход: иерархический граф компетенций (категория -> компетенция -> подкомпетенция), сопоставленный с онтологией из БД; опционально - предложения новых сущностей. 
...
**Подзадача 2 - Маппинг заданий тестирующей системы на онтологию компетенций**

Вход: задания из тестирующей системы (название, описание, тип задачи, теги, тест-кейсы). Выход: для каждого задания - список подкомпетенций из онтологии с весом присутствия (0-1), отражающим степень раскрытия подкомпетенции в данном задании. 
