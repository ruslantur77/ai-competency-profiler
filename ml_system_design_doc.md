...
Вход: банк заданий с платформы тестирования (задачи с описаниями, тест-кейсами, метаданными).
Выход: для каждого задания — список подкомпетенций из онтологии с весом (0–1), отражающим степень раскрытия подкомпетенции в данном задании, и типом покрытия (teaches/practices/evaluates).
...
- Размеченный набор из не менее 2–3 банков заданий с валидированными маппингами (ground truth для подзадачи 2).
