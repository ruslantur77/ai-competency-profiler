...
@pytest.mark.asyncio
async def test_health_endpoint_returns_ok(sqlite_session_factory) -> None:
    app.dependency_overrides[get_uow] = lambda: SQLAlchemyUnitOfWork(sqlite_session_factory)
