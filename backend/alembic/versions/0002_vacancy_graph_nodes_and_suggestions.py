...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("vacancy_id", "position", name="uq_vacancy_category_position"),
    )
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("vacancy_id", "position", name="uq_vacancy_competency_position"),
    )
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("vacancy_id", "position", name="uq_vacancy_subcompetency_position"),
    )
    op.create_table(
