...
export const finalizeVacancyGraph = (id) => api.post(`/vacancies/${id}/graph/finalize`);

export const updateVacancyStatus = (id, status) => api.patch(`/vacancies/${id}/status`, { status });
